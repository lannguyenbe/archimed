...
public class CollectionViewer extends AbstractDSpaceTransformer implements CacheableProcessingComponent
{
            ...
            UIException, SQLException, IOException, AuthorizeException
    {
        ...
        // Lan 26.10.2016 : to show metadata of the collection
        ReferenceSet referenceSet;
        if (showFullItem(objectModel))
        {
            referenceSet = home.addReferenceSet("collection-viewer",
                    ReferenceSet.TYPE_DETAIL_VIEW);
            ReferenceSet appearsInclude = referenceSet.addReference(collection).addReferenceSet(ReferenceSet.TYPE_DETAIL_LIST,null,"hierarchy");
        }
        // End - Lan 26.10.2016 : to show metadata of the collection
    ...
    /** Lan 26.01.2016 : very inspired by ItemViewer
    /**
