...
public class DiscoverQuery {
    ...
    // Lan 21.03.2017 add facetPivotsFields
    ...
    public DiscoverQuery() {
        ...
        this.facetPivotFields = new ArrayList<String>();
    ...
    /**
     * Add a new facet pivot which is a list of fields names separated by comma
     * @param facetPivotField
     */
	public void addFacetPivotField(String facetPivotField) {
		facetPivotFields.add(facetPivotField);
	}
