...
<xsl:stylesheet
    ...
    <!-- Lan 26.10.2016 : rename to old -->
    <xsl:template match="dim:dim" mode="old_collectionDetailView-DIM">
    ...
    <xsl:template match="dim:dim" mode="collectionDetailView-DIM">
        ...
        <div class="ds-table-responsive">
            <table class="ds-includeSet-table detailtable table table-striped table-hover">
                <xsl:apply-templates mode="collectionDetailView-DIM"/>
            </table>
        </div>
    ...
    <xsl:template match="dim:field" mode="collectionDetailView-DIM">
            <tr>
